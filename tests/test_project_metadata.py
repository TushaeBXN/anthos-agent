...
def test_pyproject_aiohttp_pins_match_lazy_slack_pin():
    ...
    If the two drift, `anthos update` resolves the pyproject pin and
...
def test_pyproject_pins_match_lazy_deps_pins():
    ...
    places. When they drift, `anthos update` resolves the pyproject extra
    ...
    assert not drift, (
        ...
        "for every shared package — otherwise `anthos update` downgrades the "
