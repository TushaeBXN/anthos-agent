"""Tests for the post-pull syntax guard in ``anthos update``.
...
markers in ``hermes_cli/config.py``; users who ran ``anthos update`` in
...
# release; if a future ``anthos update`` would brick users, this test fails
# in CI first.
# ---------------------------------------------------------------------------
