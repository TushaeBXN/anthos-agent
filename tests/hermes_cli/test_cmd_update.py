...
class TestCmdUpdateBranchFlag:
    """``anthos update --branch <name>`` targets the requested branch.
...
class TestCmdUpdateCheckBranchFlag:
    """``anthos update --check --branch <name>`` honors the branch override.
...
class TestCmdUpdateZipBranchRefusal:
    """``anthos update --branch=<non-main>`` must refuse on the ZIP fallback path.
