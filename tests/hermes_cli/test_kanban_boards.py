"""Tests for the multi-board kanban layer (``anthos kanban boards …``).
...
* CLI surface: ``anthos kanban boards list/create/switch/rm``.
...
def _cli(args: list[str], env_extra: dict | None = None) -> subprocess.CompletedProcess:
    """Run ``anthos kanban …`` with PYTHONPATH pinned to the worktree."""
    env = dict(os.environ)
