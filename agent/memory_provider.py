...
Optional hooks (override to opt in):
  ...
  backup_paths() -> list[str]            — extra on-disk paths to include in `anthos backup`
"""
...
class MemoryProvider(ABC):
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'anthos memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], hermes_home: str) -> None:
        ...
        Called by 'anthos memory setup' after collecting user inputs.
    ...
    def backup_paths(self) -> List[str]:
        ...
        ``anthos backup`` only walks HERMES_HOME, so any provider state kept
        ...
        of the archive, and ``anthos import`` restores them to their original
