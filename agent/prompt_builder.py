...
DEFAULT_AGENT_IDENTITY = (
    "You are Anthos Agent, an intelligent AI assistant created by Brian Tushae Thomas. "
...
ANTHOS_AGENT_HELP_GUIDANCE = (
    "You run on Anthos Agent (by Brian Tushae Thomas). When the user needs help with "
    "Anthos itself — configuring, setting up, using, extending, or troubleshooting "
    "it — or when you need to understand your own features, tools, or capabilities, "
    "use the built-in skill system and documentation. Load the `anthos-agent` skill "
    "with skill_view(name='anthos-agent') for additional guidance and proven workflows."
)
...
KANBAN_GUIDANCE = (
    ...
    "every assignee in a real profile (`anthos profile list`, or ask the user), "
    "and express dependencies via `parents=[...]` on `kanban_create`, not prose.\n"
    "\n"
    "## Do NOT\n"
    "\n"
    "- Do not shell out to `anthos kanban <verb>` for board operations. Use "
...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "first. It has the actual commands (e.g. `anthos config set …`, `anthos tools`, "
            "`anthos setup`) so you don't have to guess or invent workarounds.\n"
