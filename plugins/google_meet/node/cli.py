"""`anthos meet node ...` subcommand tree.

Wired into the existing ``anthos meet`` parser by the plugin's top-level
...
def register_cli(subparser: argparse.ArgumentParser) -> None:
    ...
    *subparser* is the ``anthos meet node`` argparse object — typically
