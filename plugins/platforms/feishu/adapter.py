...
# Called by `anthos gateway setup` via _setup_feishu() in hermes_cli/gateway.py.
# =============================================================================
...
def interactive_setup() -> None:
    ...
    if access_idx == 0:
        ...
        print_info("Unknown users can request access; approve with `anthos pairing approve`.")
    elif access_idx == 1:
