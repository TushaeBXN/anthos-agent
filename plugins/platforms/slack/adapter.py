...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            # manifest (see `anthos slack manifest`). In Socket Mode, Slack
...
def interactive_setup() -> None:
    ...
    def _write_slack_manifest_and_instruct() -> None:
        ...
        try:
            ...
            print_info(
                "   Re-run `anthos slack manifest --write` anytime to refresh after "
    ...
    if existing:
        ...
        if not prompt_yes_no("Reconfigure Slack?", False):
            ...
            if prompt_yes_no(
                ...
                "list? (recommended after `anthos update`)",
                True,
            ):
