...
Examples:
    ...
    hermes fallback add           Add a fallback provider (same picker as `anthos model`)
...
def build_top_level_parser():
    ...
    # Mirrors `anthos chat --model ... --provider ...` semantics.
    _inherited_flag(
        parser,
        "-m",
        "--model",
    ...
    _inherited_flag(
        ...
        help=(
            ...
            "under model.provider — use `anthos setup` or edit the file to change it."
        ),
    )
    parser.add_argument(
        "-t",
