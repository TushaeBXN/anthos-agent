"""
Anthos CLI - Unified command-line interface for Anthos Agent.

Provides subcommands for:
- anthos chat          - Interactive chat (same as ./anthos)
- anthos gateway       - Run gateway in foreground
- anthos gateway start - Start gateway service
- anthos gateway stop  - Stop gateway service
- anthos setup         - Interactive setup wizard
- anthos status        - Show status of all components
- anthos cron          - Manage cron jobs
"""
...
def _ensure_utf8():
    ...
    can even start — e.g. `anthos setup` on a fresh Pi.
