"""``anthos tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'anthos tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `anthos tools` runs after you pick a provider that\n"
