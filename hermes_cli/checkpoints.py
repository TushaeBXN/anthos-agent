"""`anthos checkpoints` CLI subcommand.
...
def register_cli(parser: argparse.ArgumentParser) -> None:
    """Wire subcommands onto the ``anthos checkpoints`` parser."""
    parser.set_defaults(func=cmd_status)  # bare `anthos checkpoints` → status
