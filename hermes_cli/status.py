...
def redact_key(key: str) -> str:
    ...
    "(not set)" placeholder in dim color to match ``anthos config``'s
...
def show_status(args):
    ...
    print(color("  Run 'anthos doctor' for detailed diagnostics", Colors.DIM))
    print(color("  Run 'anthos setup' to configure", Colors.DIM))
    print()
