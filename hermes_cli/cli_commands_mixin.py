...
class CLICommandsMixin:
    ...
    def _handle_handoff_command(self, cmd_original: str) -> bool:
        ...
        try:
            ...
            pass
        _cprint("  Timed out waiting for the gateway. Is `anthos gateway` running?")
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        if not target:
            ...
            if self._show_recent_sessions(reason="resume"):
                ...
                return
            _cprint("  Tip:   Use /history or `anthos sessions list` to find sessions.")
            return
        ...
        if not session_meta:
            ...
            _cprint("  Use /history or `anthos sessions list` to see available sessions.")
            return
    ...
    def _handle_curator_command(self, cmd: str):
        ...
        Delegates to hermes_cli.curator so the CLI and the `anthos curator`
    ...
    def _handle_bundles_command(self, cmd: str) -> None:
        ...
        Mirrors ``anthos bundles list`` but renders inside the running
        ...
        _cprint(
            ...
            f"Manage with `anthos bundles`.{_RST}"
        )
    ...
    def _handle_update_command(self) -> bool:
        ...
        ``anthos update`` so the user sees update output directly and gets
        ...
        raw = self._prompt_text_input_modal(
            ...
            detail="This will exit the current session and run `anthos update`.",
            choices=choices,
        )
        if raw is None:
