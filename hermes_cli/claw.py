...
def _warn_if_gateway_running(auto_yes: bool) -> None:
    ...
    print_info("Recommendation: stop the gateway first with 'anthos gateway stop'.")
    print()
...
def claw_command(args):
    ...
    if action == "migrate":
        ...
        print()
        print("Run 'anthos claw <command> --help' for options.")
...
def _cmd_migrate(args):
    ...
    # restorable with `anthos import`.  Mirrors OpenClaw's
    ...
    # 'anthos claw cleanup' separately.
