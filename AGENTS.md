# Anthos Agent - Development Guide

Instructions for AI coding assistants and developers working on the anthos-agent codebase.

**Never give up on the right solution.**

## What Anthos Is

Anthos is a personal AI agent that runs the same agent core across a CLI, a
