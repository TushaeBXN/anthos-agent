...
def _guard_agent_created_enabled() -> bool:
    ...
    on via `anthos config set skills.guard_agent_created true`.
    """
    try:
    ...
    try:
        ...
        if rec.get("pinned"):
            return (
                ...
                f"`anthos curator unpin {name}` if they want to delete it. "
    ...
    if others:
        if len(others) == 1:
            ...
            base += (
                ...
                f"another profile, switch profiles (`anthos -p "
            ...
            base += (
                ...
                f"Switch profiles (`anthos -p <name>`) to edit there, or "
...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        "will refuse with a message pointing the user to `anthos curator unpin <name>`. "
